...
import AvatarTransition from "./avatar";
import { DockDemo } from "./dock-demo";
import CardStack from "./card-stack";
import { MiniModel } from "./mini";
      ...
      >
        ...
        >
          ...
          <p className="text-sm md:text-medium">
            Hey! I&apos;m <span className="font-oleo text-2xl"> Felix</span>, a
            software engineer with a knack for Cloud, hailing from Monash and RMIT.
            Currently, I&apos;m building a cool React component library. My world revolves
            around web development, software architecture, and data science.
          </p>
